...
const handleNotification = (event) => {
  ...
  rxBuffer += chunk
  if (rxBuffer.length > MAX_RX_BUFFER_LENGTH) {
    rxBuffer = ''
    console.warn('UART receive buffer was reset because it exceeded the limit.')
    return
  }
...
export const sendStartCommand = async (command) => {
  if (!txCharacteristic) {
